    ...
    <ul class="contenedor-areas">
        <li class="area">
            <?php 
                ...
                $imagen = wp_get_attachment_image_src($area1['imagen'], 'medium')[0];
            ?>
        ...
        <li class="area">
            <?php 
                ...
                $imagen = wp_get_attachment_image_src($area2['imagen'], 'medium')[0];
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" />
        ...
        <li class="area">
            <?php 
                ...
                $imagen = wp_get_attachment_image_src($area3['imagen'], 'medium')[0];
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" />
        ...
        <li class="area">
            <?php 
                ...
                $imagen = wp_get_attachment_image_src($area5['imagen'], 'medium')[0];
            ?>
            <img src="http://gymstudio.local/wp-content/uploads/2021/07/clase1.jpg" />
            <p><?php echo esc_html( $area5['area_texto'] ); ?>
        </li>
    </ul>
</div>
...
<section class="instructores">
    <div class="contenedor seccion">
        ...
        <p class="text-center">Instructores profesionales que te ayudarán a lograr tus metas y objetivos</p>
...
<section class="blog contenedor seccion">
    ...
    <p class="text-center">Aprende tips de nuestros instructores y expertos</p>
